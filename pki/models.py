...
from pki.settings import STATIC_URL, PKI_DEFAULT_COUNTRY, PKI_DEFAULT_STATE, \
    PKI_DEFAULT_LOCALITY, PKI_DEFAULT_ORGANIZATION, PKI_DEFAULT_OU, \
    PKI_ENABLE_GRAPHVIZ, PKI_ENABLE_EMAIL, PKI_PASSPHRASE_MIN_LENGTH, \
